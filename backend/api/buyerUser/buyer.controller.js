        ...
        },
        {
          ...
          table: {
            ...
            body: [
              ...
              [{text: `${data.model} ${data.company}`, style: ''}, {text: ` GPS : $ ${bookingDetail.gpsSum}`, style: '',margin:[232,5,0,0]}],
              [{text: '', style: ''}, {text: `Insurance : $ ${bookingDetail.insuranceSum}`, style: '',margin:[232,5,0,0]}],
        ...
        },
        {
          ...
          table: {
            ...
            body: [
              ...
              [{text: 'Sales Tax (1%)', style: ''}, {text: `Payment : $ ${bookingDetail.total}`, style: '',margin:[212,0,0,0]}],
