...
import {getCarsDetails, UpdateCarData, RegisterCarOnRent, UploadCarImages} from '../actions'
...
class RegisterCar extends React.Component{
    ...
    async componentDidMount() {
        if(this.state.id){
            const res = await getCarsDetails(this.state.id);
            if (res && res.data) {
                this.setState({
                                ...
                                <div className="register_wrapper_box">
                                    <div className="register_left_form">
                                        ...
                                        <Row form>
                                            ...
                                            <Col md={6}>
                                                <Label for="exampleCity">Province</Label>
                                                <DropdownList
                                            ...
                                            <Col md={6}>
                                                <FormGroup>
                                                    ...
                                                    <Input type="text" value={data.pinCode} name="pinCode" onChange={this.onChange} placeholder="Enter pinCode " maxLength={6} />
                                                </FormGroup>
