...
import {getCarsDetails,getBuyersDetail,pdf} from "../../actions";
...
class BookingDone extends React.Component{
    ...
    componentDidMount = async ()=> {
        ...
        const res = await getBuyersDetail(this.state.id);
        if (res && res.data) {
            this.setState({buyerDetails: res.data[0]})
        }
        const response = await getCarsDetails(this.state.id);
                            ...
                            <div className="x_car_donr_main_box_wrapper_inner">
                                <div className="order-done"> <i className="icon-checked"><img src={c1} alt="" /></i>
                                    ...
                                    <ul className="row list-unstyled">
                                        ...
                                        <li className="col-md-6">
                                            <h6>Car</h6>
                                            <p>{details && details.model} {details && details.company}<span>$ {details && details.rentValue}</span>
                                            </p>
                                        </li>
                                        <li className="col-md-6">
                                            <h6>Add-ons</h6>
                                            <p>{bookingDetail.day}x GPS <span>$ {bookingDetail.gpsSum}</span>
                                            </p>
                                            <p>Extended Insurance <span>$ {bookingDetail.insuranceSum}</span>
                                            </p>
                                        </li>
                                        <li className="col-md-6">
                                            <h6>Taxes &amp; Fees</h6>
                                        ...
                                        <li className="col-md-6">
                                            <h6>Total</h6>
                                            <p>Payment on Arrival <span>$ {bookingDetail.total}</span>
                                            </p>
                                        </li>
                                        <li className="col-md-12">
                                            ...
                                            <p><strong>Name :</strong> {data.firstName} {data.lastName}
                                                ...
                                                <br /><strong>Province :</strong> {data.state}
