...
import {getCarsDetails,RegisterTheBuyer} from "../../../actions";
...
class Checkout extends React.Component{
    constructor(props){
        ...
        this.state = {
            ...
            data:{
                country:"Canada",firstName:"",lastName:"",email:"",mobile:"",drivingLicenceNumber:"",state:"",city:"",address:'',additionalInfo:"",
    ...
    async componentDidMount() {
        ...
        const res = await getCarsDetails(id);
        if (res && res.data) {
    ...
    BookingDone = async () =>{
        ...
        if (Object.keys(AllError).length > 0) {
            ...
            const res = await RegisterTheBuyer(data);
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-12">
                                            <div className="contect_btn contect_btn_contact">
                                                <ul>
                                                    <li><Link to="#" onClick={this.BookingDone} >Place an Order <i className="fa fa-arrow-right" /></Link>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
