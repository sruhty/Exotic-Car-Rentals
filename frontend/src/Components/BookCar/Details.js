...
import {getCarsDetails,getCarsList} from "../../actions"
...
class Details extends React.Component{
    ...
    async componentDidMount() {
        ...
        if (this.state.filterData) {
            ...
            await this.getCarsList(data);
        } else {
            await this.getCarsList({status: "available"});
        }
    }

    getCarsList = async (query) => {
        const res = await getCarsList(query);
        if(res && res.data){
            this.setState({
